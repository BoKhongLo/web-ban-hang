...
import { cancelOrderController, createOrderController, getOrderByIdController, getOrderUserController, updateOrderController } from "../controllers/orders.controller";
...
routerOrder.delete('/all', passport.authenticate("jwt", { session: false }), getAll);
routerOrder.delete('/update', passport.authenticate("jwt", { session: false }), updateOrderController);
