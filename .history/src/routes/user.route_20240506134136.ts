...
import { getUserByIdController, editUserByIdController, addHeartProductController } from "../controllers/users.controller";
...
routerUser.put("/remove-heart", passport.authenticate("jwt", { session: false }), removeH);
export { routerUser };
