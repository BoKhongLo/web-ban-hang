...
const validateOrderController: RequestHandler = async (req: Request, res: Response) => {
    ...
    const returnData = await validateOrderService(req.query.userId ?? req.query.userId[0], req.query.orderId ?? req.query.orderId[0], req.query.vnp_BankCode, req.query.vnp_BankTranNo);
